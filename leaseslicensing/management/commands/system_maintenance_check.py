...
from leaseslicensing.templatetags.users import system_maintenance_can_start
...
class Command(BaseCommand):
    ...
    Excecuted from cron, eg:
        ...
        * * * * * root cd /var/www/ubuntu-1604/app-grp1/leaseslicensing_prod.8094  && source venv/bin/activate && python manage_ds.py system_maintenance_check >/dev/null 2>&1
