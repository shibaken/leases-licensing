...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        print 'Logdement Number: Expiry Date: Type: ABN: Org Name: Trading Name: Org Address: Org Contacts: Org Admin Users'
            ...
            try:
                ...
                if hasattr(org, 'monthly_invoicing_allowed'):
                    print '{}: {}: {}: {}: {}: {}: {}: {}: {}'.format(
                        ...
                        list(org.contacts.filter(is_admin=True, user_role='organisation_admin').values_list('email', 'first_name', 'last_name')),
                    )
                    #print
            except Exception, e:
                #print '*********************** {}'.format(e)
