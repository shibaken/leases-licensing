...
class OrganisationRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/organisation_request_accept_notification.html'
...
class OrganisationAccessGroupRequestAcceptNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/org_access_group_request_accept_notification.html'
    txt_template = 'leaseslicensing/emails/org_access_group_request_accept_notification.txt'
...
class OrganisationRequestDeclineNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/organisation_request_decline_notification.html'
    txt_template = 'leaseslicensing/emails/organisation_request_decline_notification.txt'
...
class OrganisationContactAdminUserNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/organisation_contact_admin_notification.html'
...
class OrganisationContactSuspendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/organisation_contact_suspend_notification.html'
    txt_template = 'leaseslicensing/emails/organisation_contact_suspend_notification.txt'

class OrganisationContactReinstateNotificationEmail(TemplateEmailBase):
    subject = 'You have been Reinstated as Company User.'
    html_template = 'leaseslicensing/emails/organisation_contact_reinstate_notification.html'
    txt_template = 'leaseslicensing/emails/organisation_contact_reinstate_notification.txt'
...
class OrganisationContactDeclineNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/organisation_contact_decline_notification.html'
    txt_template = 'leaseslicensing/emails/organisation_contact_decline_notification.txt'

class OrganisationAddressUpdatedNotificationEmail(TemplateEmailBase):
    subject = 'An organisation''s address has been updated'
    html_template = 'leaseslicensing/emails/organisation_address_updated_notification.html'
    txt_template = 'leaseslicensing/emails/organisation_address_updated_notification.txt'
...
def _log_org_request_email(email_message, request, sender=None):
    from leaseslicensing.components.organisations.models import OrganisationRequestLogEntry
