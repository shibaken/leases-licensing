...
class FilmingLawfulAuthorityApprovalExpireNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/approval_lawful_authority_expire_notification.html'
    txt_template = 'leaseslicensing/emails/approval_lawful_authority_expire_notification.txt'
...
from leaseslicensing.components.organisations.models import OrganisationLogEntry, Organisation
