...
class ComplianceFeeInvoiceEventsSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/bookings/events/send_compliance_fee_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/events/send_compliance_fee_notification.txt'
...
class ApplicationInvoiceFilmingSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/bookings/filming/send_filming_fee_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/filmig/send_filming_fee_notification.txt'

class ApplicationFeeInvoiceTClassSendNotificationEmail(TemplateEmailBase):
    subject = 'Your application fee invoice.'
    html_template = 'leaseslicensing/emails/bookings/tclass/send_application_fee_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/tclass/send_application_fee_notification.txt'
...
class InvoiceTClassSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/bookings/tclass/send_invoice_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/tclass/send_invoice_notification.txt'

class MonthlyInvoiceTClassSendNotificationEmail(TemplateEmailBase):
    subject = 'Your monthly booking invoice.'
    html_template = 'leaseslicensing/emails/bookings/tclass/send_monthly_invoice_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/tclass/send_monthly_invoice_notification.txt'

class ConfirmationTClassSendNotificationEmail(TemplateEmailBase):
    subject = 'Your booking confirmation.'
    html_template = 'leaseslicensing/emails/bookings/tclass/send_confirmation_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/tclass/send_confirmation_notification.txt'
...
class SendPaymentDueNotificationTClassEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/bookings/tclass/send_payment_due_notification.html'
    txt_template = 'leaseslicensing/emails/bookings/tclass/send_payment_due_notification.txt'
