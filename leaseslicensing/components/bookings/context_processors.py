...
def leaseslicensing_url(request):
    ...
    template_group = "leaseslicensing"
    TERMS = "/know/online-leaseslicensing-booking-terms-and-conditions"
    ...
    if request.user.is_authenticated:
        ...
        is_admin = helpers.is_leaseslicensing_admin(request)
...
def template_context(request):
    ...
    context = leaseslicensing_url(request)
    return context
