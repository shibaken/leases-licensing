...
from leaseslicensing.components.proposals.serializers import SaveProposalSerializer, SaveProposalParkSerializer, SaveProposalTrailSerializer, ProposalAccreditationSerializer, ProposalOtherDetailsSerializer, SaveInternalFilmingProposalSerializer, SaveInternalEventProposalSerializer
from leaseslicensing.components.main.models import Activity, Park, AccessType, Trail, Section, Zone
import traceback
import os
...
from leaseslicensing.components.proposals.models import ProposalFilmingOtherDetails
from leaseslicensing.components.proposals.serializers_filming import ProposalFilmingOtherDetailsSerializer, ProposalFilmingActivitySerializer, ProposalFilmingAccessSerializer, ProposalFilmingEquipmentSerializer
...
from leaseslicensing.components.proposals.serializers_event import ProposalEventOtherDetailsSerializer, ProposalEventManagementSerializer, ProposalEventActivitiesSerializer, ProposalEventVehiclesVesselsSerializer
