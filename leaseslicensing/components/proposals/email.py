...
class QAOfficerSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_qaofficer_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_qaofficer_notification.txt'

class QAOfficerCompleteNotificationEmail(TemplateEmailBase):
    subject = 'A QA for an application has been completed.'
    html_template = 'leaseslicensing/emails/proposals/send_qaofficer_complete_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_qaofficer_complete_notification.txt'
...
class ReferralFilmingSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_filming_referral_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_filming_referral_notification.txt'
...
class ProposalFilmingApprovalSendNotificationEmail(TemplateEmailBase):
    subject = '{} - Commercial Operations Licence Approved.'.format(settings.DEP_NAME)
    html_template = 'leaseslicensing/emails/proposals/send_filming_approval_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_filming_approval_notification.txt'

class ProposalEventApprovalSendNotificationEmail(TemplateEmailBase):
    subject = '{} - Commercial Operations Licence Approved.'.format(settings.DEP_NAME)
    html_template = 'leaseslicensing/emails/proposals/send_event_approval_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_event_approval_notification.txt'
...
class DistrictProposalSubmitSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_district_proposal_submit_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_district_proposal_submit_notification.txt'
...
class DistrictApproverSendBackNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_district_approver_sendback_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_district_approver_sendback_notification.txt'
...
class DistrictApproverDeclineSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_district_approver_decline_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_district_approver_decline_notification.txt'
...
class DistrictApproverApproveSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_district_approver_approve_notification.html'
    txt_template = 'leaseslicensing/emails/proposals/send_district_approver_approve_notification.txt'
...
class DistrictProposalDeclineSendNotificationEmail(TemplateEmailBase):
    ...
    txt_template = 'leaseslicensing/emails/proposals/send_district_decline_notification.txt'
...
class DistrictProposalApprovalSendNotificationEmail(TemplateEmailBase):
    ...
    html_template = 'leaseslicensing/emails/proposals/send_district_approval_notification.html'
    #html_template = 'leaseslicensing/emails/proposals/send_district_decline_notification.html'
