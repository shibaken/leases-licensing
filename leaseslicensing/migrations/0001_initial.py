    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.organisation",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="leaseslicensing.proposalrequirement",
                    ),
                ),
                (
                    "proposal",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.proposals.models.update_qaofficer_doc_filename,
                    ),
                ),
                ("input_name", models.CharField(blank=True, max_length=255, null=True)),
                ("can_delete", models.BooleanField(default=True)),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="leaseslicensing.proposalrequest",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.proposals.models.update_requirement_doc_filename,
                    ),
                ),
                ("input_name", models.CharField(blank=True, max_length=255, null=True)),
                ("can_delete", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.proposals.models.update_referral_doc_filename,
                    ),
                ),
                ("input_name", models.CharField(blank=True, max_length=255, null=True)),
                ("can_delete", models.BooleanField(default=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="leaseslicensing.referraldocument",
            ),
        ),
        migrations.AddField(
            model_name="referral",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="leaseslicensing_referral_groups",
                to="leaseslicensing.referralrecipientgroup",
            ),
        ),
        migrations.CreateModel(
            name="Question",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.qaofficerdocument",
                    ),
                ),
                (
                    "proposal",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.qaofficergroup",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="leaseslicensing.proposalstandardrequirement",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.proposals.models.update_proposal_required_doc_filename,
                    ),
                ),
                ("input_name", models.CharField(blank=True, max_length=255, null=True)),
                ("can_delete", models.BooleanField(default=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.requireddocument",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.proposaldocument",
                    ),
                ),
                (
                    "proposal",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.proposalassessment",
                    ),
                ),
                (
                    "question",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="answers",
                        to="leaseslicensing.checklistquestion",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="action_logs",
                        to="leaseslicensing.organisationrequest",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="leaseslicensing.organisationcontact",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.compliancefee",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.approvals.models.update_approval_doc_filename,
                    ),
                ),
                ("can_delete", models.BooleanField(default=True)),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="leaseslicensing.approvaldocument",
            ),
        ),
        migrations.AddField(
            model_name="approval",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="leaseslicensing.applicationfee",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="leaseslicensing.communicationslogentry",
                    ),
                ),
                (
                    "proposal",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.proposals.models.update_proposal_comms_log_filename,
                    ),
                ),
                (
                    "log_entry",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="leaseslicensing.proposallogentry",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.organisations.models.update_organisation_request_comms_log_filename,
                    ),
                ),
                (
                    "log_entry",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="leaseslicensing.organisationrequestlogentry",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.organisations.models.update_organisation_comms_log_filename,
                    ),
                ),
                (
                    "log_entry",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="leaseslicensing.organisationlogentry",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        upload_to=leaseslicensing.components.compliances.models.update_compliance_comms_log_filename,
                    ),
                ),
                (
                    "log_entry",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="leaseslicensing.compliancelogentry",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="leaseslicensing.comprequest",
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="leaseslicensing.complianceamendmentreason",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=512,
                        null=True,
                        upload_to=leaseslicensing.components.approvals.models.update_approval_comms_log_filename,
                    ),
                ),
                (
                    "log_entry",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="documents",
                        to="leaseslicensing.approvallogentry",
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="leaseslicensing.amendmentreason",
                    ),
                ),
            ],
            bases=("leaseslicensing.proposalrequest",),
