                        ...
                        <div class="panel-body collapse in" :id="pBody">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group" v-if="!isLoading">
                                    ...
                                    <div v-if="profile.leaseslicensing_organisations.length > 0">
                                        <label>Do you apply </label> </br>
                                        <div v-for="org in profile.leaseslicensing_organisations" class="radio">
...
export default {
  ...
  computed: {
    ...
    org: function() {
        ...
        //     return vm.profile.leaseslicensing_organisations.find(org => parseInt(org.id) === parseInt(vm.org_applicant)).name;
        // }
    ...
    //   return this.site_url + "help/leaseslicensing/user/#apply_proposal_type"
    // },
    proposal_type_help_url: function() {
      return api_endpoints.proposal_type_help_url;
    },
    region_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_region"
    },
    district_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_district"
    },
    activity_type_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_activity_type"
    },
    sub_activity_1_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_sub_activity_1"
    },
    sub_activity_2_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_sub_activity_2"
    },
    category_help_url: function() {
      return this.site_url + "help/leaseslicensing/user/#apply_category"
    },
  ...
  methods: {
    ...
    active_proposals: function() {
        ...
        let vm = this;
        var proposals = [];
        var org = vm.profile.leaseslicensing_organisations.find(el => el.name === vm.org)
