<template lang="html">
    <div>
        <div class="form-group">
            ...
            <!-- using num_files to determine if files have been uploaded for this question/label (used in leaseslicensing/frontend/leaseslicensing/src/components/external/proposal.vue) -->
...
export default {
    ...
    computed: {
        ...
        proposal_document_action: function() {
          return (this.proposal_id) ? `/api/proposal/${this.proposal_id}/process_required_document/` : '';
        }
    },
