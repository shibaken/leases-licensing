...
export default {
    ...
    computed: {
        ...
        hasOrgs: function() {
            return this.profile.leaseslicensing_organisations && this.profile.leaseslicensing_organisations.length > 0 ? true: false;
        },
    ...
    methods: {
        ...
        orgConsultRequest: function() {
            ...
            for (var organisation in vm.profile.leaseslicensing_organisations) {
                if (new_organisation.abn && vm.profile.leaseslicensing_organisations[organisation].abn == new_organisation.abn) {
                    swal({
