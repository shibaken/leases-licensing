                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                  ...
                                  <div class="panel-body collapse in" :id="odBody">
                                      <div v-for="org in user.leaseslicensing_organisations">
                                          <div class="form-group">
...
export default {
    ...
    data () {
        ...
        return {
            ...
            user: {
                residential_address: {},
                leaseslicensingcompliance_organisations: []
            },
            loading: [],
            countries: [],
                ...
                if (result.value) {
                    vm.$http.post(helpers.add_endpoint_json(api_endpoints.organisations,org.id+'/unlink_user'),JSON.stringify(vm.user),{
                        ...
                        vm.$http.get(helpers.add_endpoint_json(api_endpoints.users,vm.user.id)).then((response) => {
                            vm.user = response.body
                            if (vm.user.residential_address == null){ vm.user.residential_address = {}; }
                            if (vm.user.leaseslicensingcompliance_organisations && vm.user.leaseslicensingcompliance_organisations.length > 0){
                              vm.managesOrg = 'Yes'
                            }
                            swal(
                                'Unlink',
